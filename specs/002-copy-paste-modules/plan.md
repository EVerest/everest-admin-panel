...
**Branch**: `002-copy-paste-modules` | **Date**: 2025-12-02 | **Spec**: `specs/002-copy-paste-modules/spec.md`
...
│       └── views/                # Konva views (ModuleView)
```

**Structure Decision**: Single project (Vue frontend). Logic resides in `evconf_konva` (controller) and `evbc` (model).## Complexity Tracking
